    ...
    <div className="space-y-6 pb-10 max-w-[1400px] mx-auto text-slate-900 dark:text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div 
          ...
          className="bg-[#1C274C] rounded-[2rem] p-6 md:p-8 relative overflow-hidden border border-white/5 min-h-[200px] shadow-[0_10px_30px_rgba(28,39,76,0.3)] hover:shadow-[0_20px_40px_rgba(59,130,246,0.3)] hover:-translate-y-2 hover:border-blue-400 transition-all duration-500 cursor-pointer group text-white flex flex-col justify-between"
        >
          <div className="absolute inset-0 pointer-events-none opacity-30">
          ...
          <div className="flex justify-between items-center mb-6 relative z-10">
             <h3 className="text-xs font-bold text-slate-300 uppercase tracking-widest">THỐNG KÊ CÁ NHÂN</h3>
          </div>
          <div className="grid grid-cols-2 gap-4 relative z-10">
            <div className="bg-white/5 rounded-2xl p-4 border border-white/10 group-hover:border-white/20 transition-colors">
               <div className="flex items-center gap-2 mb-2">
                  <PlayCircle className="w-4 h-4 text-[#FFD15B]" />
                  <span className="text-xs text-slate-400 font-bold uppercase">Lớp học số</span>
               </div>
               <p className="text-2xl font-bold text-white">0 <span className="text-xs font-normal text-slate-400">bài</span></p>
            </div>
            <div className="bg-white/5 rounded-2xl p-4 border border-white/10 group-hover:border-white/20 transition-colors">
               <div className="flex items-center gap-2 mb-2">
                  <FileText className="w-4 h-4 text-blue-400" />
                  <span className="text-xs text-slate-400 font-bold uppercase">Tài liệu</span>
               </div>
               <p className="text-2xl font-bold text-white">0 <span className="text-xs font-normal text-slate-400">tệp</span></p>
            </div>
            <div className="bg-white/5 rounded-2xl p-4 border border-white/10 group-hover:border-white/20 transition-colors">
               <div className="flex items-center gap-2 mb-2">
               ...
               <p className="text-2xl font-bold text-white">0 <span className="text-xs font-normal text-slate-400">câu</span></p>
            </div>
            <div className="bg-white/5 rounded-2xl p-4 border border-white/10 group-hover:border-white/20 transition-colors">
               <div className="flex items-center gap-2 mb-2">
                  <Crown className="w-4 h-4 text-amber-400" />
                  <span className="text-xs text-slate-400 font-bold uppercase">Điểm thưởng</span>
               </div>
               <p className="text-2xl font-bold text-white">{currentUser?.coins || 0} <span className="text-xs font-normal text-slate-400">coin</span></p>
            </div>
          </div>
        </motion.div>
